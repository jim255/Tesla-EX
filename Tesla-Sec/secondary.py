...
#constants for 2 layer primary coil @20 3mm trace 3.5mm turns ( 2 * 10 )  3 Oz copper?
    TrackWidth = 0.2
    TrackDistance = 0.4
    Turns = 120

# OLD  Center = [115.0,105.0] # x/y coordinates of the centre of the pcb sheet

# top copper
    Center = [115.0,105.0] # x/y coordinates of the centre of the pcb sheet
    Radius = 0 # start radius in mm
    Sides = 36.0
    StartAngle =0.00 # degrees
    Spin = +1 # ccw = +1, cw = -1
    Layer = "fcu"
    Net = "1"
